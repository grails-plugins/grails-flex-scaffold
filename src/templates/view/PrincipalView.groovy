...
<mx:VBox xmlns:mx="http://www.adobe.com/2006/mxml"
	...
	<mx:Script><![CDATA[
		...
		private function changeTab():void {
			UIComponent(tn.selectedChild).setFocus();
		}
		...
		private function doInit():void {
			GFS::security {
				BindingUtils.bindSetter(createTabs, appModel, "logged");
			}
		...
		private function addBg():void {
			...
			rawChildren.addChildAt(backgroundBox, 1);
		}
	...
	<mx:Canvas id="headerContainer" width="100%"
	           clipContent="false" height="40">
		<mx:Image id="imgLogo" y="14" x="10" source="{logo}"/>

		<mx:Canvas id="initContainer"
		           x="{headerContainer.width-initContainer.width-10}" y="5">
			<mx:Label id="lblGfs" text="GFS" styleName="gfsTitle"/>
			<mx:Label y="2" x="2" text="GFS" alpha="0.5" styleName="gfsTitle"/>
			<mx:Label id="lblSub" x="{lblGfs.width + 2}" y="9"
