...
<mx:VBox xmlns:mx="http://www.adobe.com/2006/mxml"
	...
	<mx:Script><![CDATA[
		...
		private function showEditView():void {
			editView = PopUpManager.createPopUp(DisplayObject(FlexGlobals.topLevelApplication),view.${domainClass.propertyName}.external.${className}RelationEditView,true)
