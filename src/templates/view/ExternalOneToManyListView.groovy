...
<mx:VBox xmlns:mx="http://www.adobe.com/2006/mxml"
	...
	<mx:Script><![CDATA[
		...
		private function showNewView():void {
			editView = PopUpManager.createPopUp(DisplayObject(FlexGlobals.topLevelApplication),${className}PopSelect,true)
		...
		private function create${className}EditView(mode:String):void {
			...
			pop = PopUpManager.createPopUp(DisplayObject(FlexGlobals.topLevelApplication),TitleWindow,true);
	...
	<cubikalabs:CBKDataGrid dataProvider="{dataProvider}" width="100%" height="100%" id="dg"
		                     itemDoubleClick="showEditView()" doubleClickEnabled="true" variableHeight="true" rowCount="8">
		<cubikalabs:columns>
<%
