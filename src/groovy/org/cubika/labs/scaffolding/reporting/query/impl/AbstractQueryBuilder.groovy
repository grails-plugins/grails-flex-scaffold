...
/**
 * Basic query builder functionality description, its subclasses has the responsibilty
 * of adding to stringQuery and queryParameters of the QueryObject a part of string and
 * an entry respectively.
 */
abstract class AbstractQueryBuilder implements ReportingBuilder {
	...
	AbstractQueryBuilder(prop, value, queryObj) {
		propName = prop.name
		propType = prop.typePropertyName
		valueString = value
