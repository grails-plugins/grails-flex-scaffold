...
/**
 * Gives basic functionality for all form item builders.
 *
...
abstract class AbstractBuildFormItem implements BuildFormItem {
	...
	AbstractBuildFormItem(property) {
		...
		constraint = property.domainClass.constrainedProperties[property.name]
	 ...
	 */
	String getFormItemID() { "fi${FSU.capitalize(property.name)}" }
	 ...
	 */
	protected abstract String buildFormItemComponent(property)
}
