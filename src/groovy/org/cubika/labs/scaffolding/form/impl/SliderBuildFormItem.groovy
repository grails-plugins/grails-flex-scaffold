...
/**
 * Extends AbstractBuildFormItem adding Slider building functionality.
 *
...
class SliderBuildFormItem extends AbstractBuildFormItem {
	 ...
	 * Constructor
	 */
	SliderBuildFormItem(property, String direction = "V") {
		super(property)
	...
	String buildFormItemComponent(binding) {
		...
		pw.println """				<mx:${direction}Slider id="${getID()}" value="{${binding}}" """ +
			"""minimum="${constraint.min ?: -999999}" maximum="${constraint.max ?: 999999}" """ +
	 ...
	 * @see #AbstractBuildFormItem
	 */
	String getID() { "ns${FSU.capitalize(property.name)}" }
